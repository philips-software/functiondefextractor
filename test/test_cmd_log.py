...
from functiondefextractor.extractor_cmd import create_parser
...
class ParserAndLogTest(unittest.TestCase):
    ...
    #     script = os.path.abspath(os.path.join(TestResource.par_dir, "function_def_extractor",
    #                                           "function_def_extractor_cmd.py"))
